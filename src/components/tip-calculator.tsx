...
// / Custom CSS for the animated gradient background
const animatedGradientStyle = {
  background: 'linear-gradient(270deg, #ff6b6b, #ffcc00, #1dd1a1, #5f27cd)',
  backgroundSize: '800% 800%',
  animation: 'gradient-animation 10s ease infinite',
};

// Keyframes animation definition for the gradient
...
export default function TipCalculator() {
  ...
  return (
    <>
      ...
      {/* Injecting the keyframes style */}
      <style>{gradientAnimationStyle}</style>
      
      <div
        className="flex flex-col items-center justify-center min-h-screen"
        style={animatedGradientStyle} // Apply the animated gradient style
      >
      {/* Center the tip calculator card within the screen */}
      <Card className="w-full max-w-md p-6 bg-gradient-to-r from-red-300  to-blue-300 dark:bg-gray-800 shadow-lg rounded-lg">
        <CardHeader>
